...
Naming conventions are established during discovery workshops with customers to ensure consistency across all Azure Local infrastructure components. Azure Local Cloud follows **Microsoft Cloud Adoption Framework (CAF)** naming standards aligned with Azure best practices and the Azure Local Cloud Master Variable Registry.
