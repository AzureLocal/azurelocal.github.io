...
:::tip Consult your hardware vendor
Azure Local nodes are validated with specific HBA models. Consult your server vendor's Azure Local configuration guide for the supported HBA list. The HBA driver must be installed before Arc registration — see [Phase 03 Task 12](../implementation/04-cluster-deployment/phase-03-os-configuration/task-12-install-fc-hba-drivers-conditional.mdx).
:::
...
- [Microsoft Learn — FC planning pattern without backup](https://learn.microsoft.com/en-us/azure/azure-local/plan/fiber-channel-no-backup-disaggregated-pattern?view=azloc-2604)
- [Microsoft Learn — FC planning pattern with backup](https://learn.microsoft.com/en-us/azure/azure-local/plan/fiber-channel-with-backup-disaggregated-pattern?view=azloc-2604)
