...
|---------------|---------|----------------|----------------|
| **Cluster Nodes** | `{CUSID}{SITE}AX{NN}` | `CONNYCAX01` | `CONDFWAX01` |
| **Cluster Name** | `{CUSID}-AZL-{SITE}-{NN}` | `CON-AZL-NYC-01` | `CON-AZL-DFW-01` |
| **Resource Group** | `rg-{cusid}-azlocal-{site}-{nnn}` | `rg-con-azlocal-nyc-001` | `rg-con-azlocal-dfw-001` |
| **VNet** | `vnet-{cusid}-{site}-{env}` | `vnet-con-nyc-prod` | `vnet-con-dfw-prod` |
| **Key Vault** | `kv-{cusid}-{site}-{env}` | `kv-con-nyc-prod` | `kv-con-dfw-prod` |
| **Storage Account** | `st{cusid}{site}{env}` | `stconnycstor001` | `stcondfwstor001` |
| **Log Analytics** | `law-{cusid}-{scope}-{region}` | `law-con-central-eus` | (shared) |
