...
> **SCOPE**: Validate identity, permissions, and connectivity before Arc registration
> **PURPOSE**: Validate identity, permissions, and connectivity before Arc registration
> **MASTER REFERENCE**: [Azure Arc Requirements](https://learn.microsoft.com/en-us/azure/azure-arc/servers/prerequisites)
...
> **When to use**: Self-contained deployment without shared config file.

**Script**: See [azurelocal-toolkit](https://github.com/AzureLocal/azurelocal-toolkit).

:::note Content Pending
See Orchestrated Script tab for primary implementation.
:::
