...
> **RUN DURING**: [Task 9: Validation](../deployment-methods/s2d/local-identity/portal-instructions.mdx#task-9-validation) — after clicking **Start validation** in the portal
...
**Version Control**
- Created: 2026-03-09 by Azure Local Cloud
