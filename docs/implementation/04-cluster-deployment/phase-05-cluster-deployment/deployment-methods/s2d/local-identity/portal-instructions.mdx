...
[![GA](https://img.shields.io/badge/Status-GA-green?style=flat-square)](https://learn.microsoft.com/en-us/azure/azure-local/deploy/deployment-local-identity-with-key-vault?view=azloc-2604)
...
Windows Admin Center (WAC) is **not supported** with Local Identity deployments. Use PowerShell or the Azure portal for administrative tasks.

**Source**: [MS Learn — Local Identity with Key Vault](https://learn.microsoft.com/en-us/azure/azure-local/deploy/deployment-local-identity-with-key-vault?view=azloc-2604)
:::
...
**Version Control**
- Created: 2026-01-31 by Azure Local Cloud
- Last Updated: 2026-03-08 by Azure Local Cloud
- Version: 1.1.0
