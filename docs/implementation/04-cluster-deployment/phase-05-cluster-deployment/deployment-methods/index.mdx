...
For Azure Local Cloud Azure Local Anywhere deployments, **Active Directory with ARM Template** is the standard approach for consistency and repeatability.
:::
...
For standard Azure Local Cloud Azure Local Anywhere deployments:
