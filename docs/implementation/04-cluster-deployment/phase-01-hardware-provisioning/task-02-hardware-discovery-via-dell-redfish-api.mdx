...
|---------|------|--------|---------|
| 1.0 | 2026-01-01 | Azure Local Cloud | Initial document |
| 1.1 | 2026-03-03 | Azure Local Cloud | Fix tab labels, schema keys, standards alignment |
| 1.2 | 2026-03-04 | Azure Local Cloud | Add variables.yml update instructions to all three tabs; document Update-InfrastructureYml-FromDiscovery.ps1 integration |