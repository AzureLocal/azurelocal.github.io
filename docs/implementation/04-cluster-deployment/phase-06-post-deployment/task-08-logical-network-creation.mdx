---
title: "Task 08: Logical Network Creation"
sidebar_label: "Task 08: Logical Networks"
sidebar_position: 8
description: "Create Azure Local logical networks for Arc VM network connectivity"
category: "Runbook"
scope: "Create Azure Local logical networks for Arc VM network connectivity"
purpose: "Create Azure Local logical networks for Arc VM network connectivity"
...
> **PURPOSE**: Create all logical networks defined in `variables.yml`. Each entry is
> **MASTER REFERENCE**: [Azure Local Logical Networks](https://learn.microsoft.com/en-us/azure/azure-local/manage/create-logical-networks)
...
7. Under **Network Security Group**, select the NSG created in [Task 07](./task-07-configure-nsgs.mdx):
...
9. Repeat for each additional logical network in `networking.logical_networks[]`.
...
**Script:**
[`New-LogicalNetworks-Standalone.ps1`](https://github.com/AzureLocal-docs-azl-toolkit/-/blob/main/scripts/deploy/04-cluster-deployment/phase-06-post-deployment/task-08-logical-network-creation/powershell/New-LogicalNetworks-Standalone.ps1)
...
| | |
|---|---|
| ← Previous | [Task 07 — Configure NSGs](./task-07-configure-nsgs.mdx) |
| ↑ Phase Index | [Phase 06 — Post-Deployment Index](./index.mdx) |
| → Next | [Task 09 — Post-Deployment Verification](./task-09-post-deployment-verification.mdx) |
