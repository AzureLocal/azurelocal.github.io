...
node list and credentials from `infrastructure.yml`. Produces a timestamped log in
...
`infrastructure.yml` required. Edit the `#region CONFIGURATION` block and run from any
