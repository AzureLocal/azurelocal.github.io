---
title: "Task 09: Post-Deployment Verification"
sidebar_label: "Task 09: Verification"
sidebar_position: 9
description: "Verify all Phase 06 post-deployment tasks completed successfully"
category: "Runbook"
scope: "Verify all Phase 06 post-deployment tasks completed successfully"
purpose: "Verify all Phase 06 post-deployment tasks completed successfully"
...
# Task 09 — Post-Deployment Verification
...
> **MASTER REFERENCE**: [Azure Local Deployment Validation](https://learn.microsoft.com/en-us/azure/azure-local/deploy/deployment-introduction)
...
`logs/task-09-post-deployment-verification/` for handoff documentation.

**Script:**
[`Invoke-VerifyPostDeployment.ps1`](https://github.com/AzureLocal-docs-azl-toolkit/-/blob/main/scripts/deploy/04-cluster-deployment/phase-06-post-deployment/task-09-post-deployment-verification/powershell/Invoke-VerifyPostDeployment.ps1)

```
scripts/deploy/04-cluster-deployment/phase-06-post-deployment/
 task-09-post-deployment-verification/powershell/Invoke-VerifyPostDeployment.ps1
```
...
.DESCRIPTION
 Phase 06 — Post-Deployment | Task 09 — Post-Deployment Verification
 ...
 05 (storage), 06 (VM images via az CLI), 07 (NSGs via az CLI), 08 (logical networks via az CLI).
...
.PARAMETER LogPath
 Override log file path. Default: logs\task-09-post-deployment-verification\
...
.EXAMPLE
 ...
 .\scripts\deploy\04-cluster-deployment\phase-06-post-deployment\task-09-post-deployment-verification\powershell\Invoke-VerifyPostDeployment.ps1
...
#region LOGGING -----------------------------------------------------------------
$taskFolderName = "task-09-post-deployment-verification"
...
Write-Log "======================================================="
Write-Log " Task 09 — Post-Deployment Verification (Orchestrated)"
...
# ── Task 08: Logical Networks (Azure) ────────────────────────────────────────
Write-Log ""; Write-Log "Task 08 — Logical Networks (Azure)"
if (-not $subscriptionId -or -not $resourceGroup) {
...
**Script:**
[`Test-PostDeployment-Standalone.ps1`](https://github.com/AzureLocal-docs-azl-toolkit/-/blob/main/scripts/deploy/04-cluster-deployment/phase-06-post-deployment/task-09-post-deployment-verification/powershell/Test-PostDeployment-Standalone.ps1)

```
scripts/deploy/04-cluster-deployment/phase-06-post-deployment/
 task-09-post-deployment-verification/powershell/Test-PostDeployment-Standalone.ps1
```
...
| | |
|---|---|
| ← Previous | [Task 08 — Logical Network Creation](./task-08-logical-network-creation.mdx) |
