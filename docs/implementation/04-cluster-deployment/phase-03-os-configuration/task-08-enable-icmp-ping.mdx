...
updated: 2026-03-04
version: 2.0
tags: ["azure-local", "os-configuration", "firewall", "icmp", "ping", "networking", "powershell"]
keywords: ["enable ICMP", "Enable-ICMPFirewallRule", "Invoke-EnableICMP-Orchestrated", "ICMPv4-In", "ICMPv6-In", "Enable-NetFirewallRule"]
status: Active
---
...
No configuration variables are required — this task has no values to read from `infrastructure.yml`.
...
```powershell title="Enable-ICMPFirewallRule.ps1"
<#
.SYNOPSIS
...
Reads all `cluster_nodes` entries from `infrastructure.yml`. Connects to each
...
.EXAMPLE
 .\Invoke-EnableICMP-Orchestrated.ps1
 .\Invoke-EnableICMP-Orchestrated.ps1 -ConfigPath "C:\configs\infrastructure.yml"
#>
