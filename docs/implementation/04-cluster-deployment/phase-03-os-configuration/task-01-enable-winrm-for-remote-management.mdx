...
|---------|--------|---------|
| Management server subnet | `infrastructure.yml: network.management_subnet` | `10.245.64.*` |
| Point-to-site VPN client pool | `infrastructure.yml: p2s_client_address_pool` | `172.16.0.0/24` |
...
# - Management server subnet (infrastructure.yml: network.management_subnet)
# - P2S VPN client pool (infrastructure.yml: p2s_client_address_pool)
