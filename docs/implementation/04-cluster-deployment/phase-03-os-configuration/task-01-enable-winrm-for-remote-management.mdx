...
> **When to use**: Use this option when deploying across multiple nodes from a management server using `variables.yml`.

**Script**: See [zurelocal-toolkit](https://github.com/AzureLocal/azurelocal-toolkit) -> `scripts/deploy/` for the orchestrated script for this task.
...
| 1.1 | 2026-03-04 | Azure Local Cloud | Remove tabs, flat prose version |
| 1.2 | 2026-03-04 | Azure Local Cloud | Incorrect orchestrated tab removed |
| 1.3 | 2026-03-04 | Azure Local Cloud | Direct (On Node) + Standalone tabs |
| 1.4 | 2026-03-04 | Azure Local Cloud | Incorrectly replaced with single orchestrated tab |
| 1.5 | 2026-03-04 | Azure Local Cloud | Single Direct Script (On Node) tab with correct bootstrap script |
| 1.6 | 2026-03-04 | Azure Local Cloud | Add TrustedHosts Configuration section covering management subnet, P2S VPN pool, and delivery engineer network |
