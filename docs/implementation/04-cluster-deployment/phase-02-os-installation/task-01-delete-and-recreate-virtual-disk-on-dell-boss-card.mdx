...
updated: 2026-03-04
version: 1.1
tags: ["azure-local", "os-installation", "dell", "boss-card", "raid", "idrac", "redfish"]
keywords: ["Dell BOSS card", "BOSS-S2", "RAID-1", "virtual disk", "iDRAC Storage Management", "Redfish API", "BOSS-N1"]
status: Active
---
...
| iDRAC access | iDRAC UI and Redfish API accessible | `infrastructure.yml: nodes.<name>.idrac_ip` |
...
Mount and execute from the management server. Reads iDRAC IPs from `infrastructure.yml` and credentials from Key Vault.
