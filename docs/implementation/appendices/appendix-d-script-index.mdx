...
|-----------|------|:-----:|:---------:|:-----------:|:---------:|--------|
| 01 - B2B Configuration | Customer tenant cross-tenant access policy | — | — | 📋 | — | Planned |
| 01 - B2B Configuration | MSP MGMT cross-tenant sync configuration | — | — | 📋 | — | Planned |
| 02 - CI/CD Setup | CI/CD runner deployment | — | — | — | 📋 | Planned |
...
2. **Variables** — Read from `infrastructure.yml` or passed as parameters
