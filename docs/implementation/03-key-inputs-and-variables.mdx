...
sidebar_position: 3
description: "Configuration management system for Azure Local deployments using master-registry.yaml and infrastructure.yml."
category: "RUNBOOK"
...
Azure Local deployments use a **standardized configuration management system** based on two core files:
