...
<TabItem value="direct" label="Direct Script (On WAC Server)">

### Direct Script (On WAC Server)

> **When to use**: Run directly on the WAC server — silent WAC installation, no variables.yml access
...
# Execution: Run ON the WAC server — standalone, no config file access
# Prerequisites: Windows Server 2019+, internet access
# ============================================================================
...
if ($svc -and $svc.Status -eq "Running") {
    ...
    Write-Host "WAC service not found or not running — check C:\Temp\wac-install.log" -ForegroundColor Red
}
