...
| Previous | Up | Next |
|----------|-----|------|
| [← Task 05: Deploy OMIMSWAC Monitoring](./task-05-deploy-omimswac-monitoring.mdx) | [Phase 02: Monitoring & Observability](./index.mdx) | [Task 07: Configure Datadog Integration ->](./task-07-configure-datadog-integration.mdx) |
