...
Terraform code for deployment of the Datadog agent via Azure Policy is available in the Azure Local Cloud repository: `tf-module-azr-datadog-integration`
:::
...
- Azure Local Cloud Terraform Module: `tf-module-azr-datadog-integration`
