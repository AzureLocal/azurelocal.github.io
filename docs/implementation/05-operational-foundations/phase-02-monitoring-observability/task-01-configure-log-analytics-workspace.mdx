...
category: "Runbook"
scope: "Create and configure the Log Analytics workspace for Azure Local monitoring a..."
purpose: "Create and configure the Log Analytics workspace for Azure Local monitoring and observability"
...
| Previous | Up | Next |
|----------|-----|------|
| [← Phase 01: SDN Deployment](../phase-01-sdn-deployment/index.mdx) | [Phase 02: Monitoring & Observability](./index.mdx) | [Task 02: Azure Monitor Agent →](./task-02-configure-azure-monitor-agent.mdx) |
