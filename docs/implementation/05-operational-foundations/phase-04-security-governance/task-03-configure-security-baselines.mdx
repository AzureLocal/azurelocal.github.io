...
category: "Runbook"
scope: "Review and remediate Defender for Cloud security recommendations for Azure Local"
purpose: "Review and remediate Defender for Cloud security recommendations for Azure Local"
...
| Previous | Up | Next |
|----------|-----|------|
| [← Task 02: Azure Policy](./task-02-apply-azure-policy-initiatives.mdx) | [Phase 04: Security & Governance](./index.mdx) | [Task 04: Security Logging →](./task-04-enable-security-logging.mdx) |
