...
This script is completely self-contained. Edit the values in the `#region CONFIGURATION` block and run. No `infrastructure.yml`, no config-loader, no helpers required.
:::
