...
category: "Runbook"
scope: "Validate disaster recovery procedures with test failovers and failback testing"
purpose: "Validate disaster recovery procedures with test failovers and failback testing"
...
| Previous | Up | Next |
|----------|-----|------|
| [← Task 02: Configure Site Recovery](./task-02-configure-site-recovery.mdx) | [Phase 03: Backup & DR](./index.mdx) | --- |
