...
updated: 2026-03-03
version: 1.1
tags: ["azure-local", "opengear", "lighthouse", "console-server", "oob-management"]
keywords: ["OpenGear", "Lighthouse portal", "console server", "serial ports", "OOB"]
status: Active
---
...
> **When to use**: Quick verification without infrastructure.yml — manually set variables in the configuration block.
...
|------|----------------|------------|--------|
| Console ports | Per infrastructure.yml `network_devices.opengear.ports.console` | ☐ | ☐ |
| Network ports | Per infrastructure.yml `network_devices.opengear.ports.network` | ☐ | ☐ |
| Switch ports | Per infrastructure.yml `network_devices.opengear.ports.switch` | ☐ | ☐ |
...
| IP Address | Per infrastructure.yml `vlans.oob` | ☐ |
...
# from infrastructure.yml: nodes.<node_name>.idrac_ip
ping -c 2 <IDRAC_IP_NODE1>
ping -c 2 <IDRAC_IP_NODE2>
# Repeat for all nodes defined in infrastructure.yml
```
