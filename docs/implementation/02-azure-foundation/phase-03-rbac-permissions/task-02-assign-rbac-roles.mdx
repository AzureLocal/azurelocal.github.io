...
- [ ] Subscription ID confirmed in `infrastructure.yml` → `azure.subscriptions.lab.id`
- [ ] Cluster resource group confirmed in `infrastructure.yml` → `azure_resources.resource_group_name`
