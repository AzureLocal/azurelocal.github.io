...
| **`infrastructure.yml`** | Configured with resource group names per subscription |
...
- [ ] Resource group names match `infrastructure.yml`
...
- Version: 2.0.0
- Tags: azure-local, phase-01, resource-groups, full-deployment
- Keywords: resource groups, multi-subscription, naming conventions
- Author: Azure Local Cloudnology Team
