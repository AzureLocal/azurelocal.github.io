...
Create the complete management group hierarchy under the existing root management group, following Azure Cloud Adoption Framework (CAF) and Well-Architected Framework (WAF) best practices. This establishes the enterprise-grade governance structure for multi-subscription Azure Local environments.

### What This Accomplishes

- **Governance structure** — complete CAF-aligned management group hierarchy
- **Policy inheritance** — hierarchical policy and RBAC inheritance from root down
- **Landing zone organization** — structured landing zones for different workload types
- **Lifecycle management** — sandbox and decommissioned MGs for non-production and teardown

:::info Root Management Group
The root management group (`azure.management_groups.tenant_root.name`) should already exist in the tenant. This task creates everything **beneath** it — platform, landing zones, sandbox, and decommissioned.
:::
...
- **`infrastructure.yml`** configured with the full management group hierarchy
...
- [ ] All IDs and display names match `infrastructure.yml`
...
> **When to use**: Scripted deployment reading values from `infrastructure.yml`
...
- [Microsoft Learn — CAF Ready Methodology](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/)
...
- Version: 2.0.0
- Tags: azure-local, phase-01, management-groups, full-deployment
- Keywords: management groups, CAF hierarchy, governance structure
- Author: Azure Local Cloudnology Team
