...
| Syslog / NDM | `compute.vms.management.syslog` | Syslog + SNMP receiver | [Part 5, Phase 02, Task 07](../../05-operational-foundations/phase-02-monitoring-observability/task-06-configure-network-device-logging.mdx) |
