---
title: "Task 16: Configure Windows Admin Center"
sidebar_label: "Task 16: Configure WAC"
sidebar_position: 16
...
# Task 16: Configure Windows Admin Center
...
- [ ] [Task 13: Configure Utility Server](./task-13-configure-utility-server) completed — utility VM domain-joined
...
> **When to use**: Run directly on the utility VM — silent WAC installation, no infrastructure.yml access
...
| Previous | Up | Next |
|----------|-----|------|
| [Task 15: Lighthouse Server](./task-15-configure-lighthouse) | [Manual Deployment Index](./index.mdx) | — |
