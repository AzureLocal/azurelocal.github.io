---
title: "Task 12: Configure Active Directory Domain Services"
sidebar_label: "Task 12: Configure AD DS"
sidebar_position: 12
...
# Task 12: Configure Active Directory Domain Services
...
- [ ] [Task 11: Deploy Management VMs](./task-11-deploy-management-vms) completed — dc01 and dc02 running
...
> **When to use**: Run directly on the VM via Bastion RDP session — no infrastructure.yml access
...
> **When to use**: Run from management workstation via PSRemoting — reads `infrastructure.yml`
...
| Previous | Up | Next |
|----------|-----|------|
| [Task 11: Deploy Mgmt VMs](./task-11-deploy-management-vms) | [Manual Deployment Index](./index.mdx) | [Task 13: Configure Utility Server](./task-13-configure-utility-server) |
