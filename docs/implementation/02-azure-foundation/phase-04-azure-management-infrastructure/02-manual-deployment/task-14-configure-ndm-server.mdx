---
title: "Task 14: Configure NDM Server"
sidebar_label: "Task 14: NDM Server"
sidebar_position: 14
...
- [ ] [Task 11: Deploy Management VMs](./task-11-deploy-management-vms) completed — NDM VM running
...
| Previous | Up | Next |
|----------|-----|------|
| [Task 13: Utility Server](./task-13-configure-utility-server) | [Manual Deployment Index](./index.mdx) | [Task 15: Lighthouse Server](./task-15-configure-lighthouse) |
