---
title: "Task 13: Configure Utility Server"
sidebar_label: "Task 13: Utility Server"
sidebar_position: 13
...
# Task 13: Configure Utility Server
...
- [ ] [Task 12: Configure AD DS](./task-12-configure-adds) completed — domain functional
...
> **When to use**: Run directly on the utility VM via Bastion RDP session — no infrastructure.yml access
...
| Previous | Up | Next |
|----------|-----|------|
| [Task 12: Configure AD DS](./task-12-configure-adds) | [Manual Deployment Index](./index.mdx) | [Task 14: Configure NDM Server](./task-14-configure-ndm-server) |
