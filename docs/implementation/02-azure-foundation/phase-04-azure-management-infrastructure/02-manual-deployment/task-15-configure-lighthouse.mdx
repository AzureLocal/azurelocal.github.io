---
title: "Task 15: Configure Lighthouse Server"
sidebar_label: "Task 15: Lighthouse Server"
sidebar_position: 15
...
# Task 15: Configure Lighthouse Server
...
- [ ] [Task 11: Deploy Management VMs](./task-11-deploy-management-vms) completed — Lighthouse VM running
...
> **When to use**: Run from management workstation via SSH — reads `infrastructure.yml`
...
CONFIG_PATH="${1:-configs/infrastructure.yml}"
...
| Previous | Up | Next |
|----------|-----|------|
| [Task 14: NDM Server](./task-14-configure-ndm-server) | [Manual Deployment Index](./index.mdx) | [Task 16: Configure WAC](./task-16-configure-wac) |
