...
> **MASTER REFERENCE**: [tf-module-azr-local](https://github.com/AzureLocal/tf-module-azr-local/azurerm)
...
The pipeline uses the **[tf-module-azr-local](https://github.com/AzureLocal/tf-module-azr-local)** Terraform module (version ~3.0) to deploy all management infrastructure in a standardized, repeatable way.

:::tip Module Documentation
For detailed configuration options, variable reference, and advanced features, see the [tf-module-azr-local README](https://github.com/AzureLocal/tf-module-azr-local/azurerm/-/blob/main/README.md).
:::
...
- **Module Repository**: [github.com/AzureLocal/tf-module-azr-local](https://github.com/AzureLocal/tf-module-azr-local/azurerm)
