...
> **MASTER REFERENCE**: [CI/CD pipeline Pipelines](https://docs.gitlab.com/ee/ci/pipelines/)
...
- Commit Terraform configuration changes and push to GitLab repository
...
- [ ] Code committed and pushed to GitLab successfully
