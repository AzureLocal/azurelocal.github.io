...
- Configure core customer identification and CI/CD Infrastructure integration variables
...
- [ ] Core variables defined with correct customer ID, environment, location, tenant ID
