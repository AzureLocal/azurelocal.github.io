...
| Syslog / NDM | `compute.vms.management.syslog` | Syslog + SNMP receiver → Azure Monitor | [Part 5, Phase 02, Task 07](../../../05-operational-foundations/phase-02-monitoring-observability/task-07-configure-network-device-logging.mdx) |
...
- **Syslog / NDM Server** — Configured in [Part 5, Phase 02, Task 07: Network Device Logging](../../../05-operational-foundations/phase-02-monitoring-observability/task-07-configure-network-device-logging.mdx). Syslog server requirements are documented inline there.
