...
After completing this phase, continue to [Part 2: CI/CD Pipelines](../../02-cicd-pipelines/) to select the platform that will run your automation. Use the [Implementation Guide](../../../implementation/index.mdx) for the end-to-end deployment sequence.
