...
After completing runner deployment, continue to [Part 2: CI/CD Pipelines](../../02-cicd-pipelines/) to configure the delivery workflow for your chosen platform. Use the [Implementation Guide](../../../implementation/index.mdx) when you are ready to execute the deployment phases themselves.
