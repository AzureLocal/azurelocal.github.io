...
After completing Part 1, proceed to [Part 2: CI/CD Pipelines](../02-cicd-pipelines/) to choose and configure the delivery platform. Then return to the [Implementation Guide](../../implementation/index.mdx) when you are ready to execute Azure foundation deployment phases.
