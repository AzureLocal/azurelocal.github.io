...
sidebar_position: 2
description: "As-built documentation for Azure Local lab environments"
---
...
As-built documentation of how the Azure Local lab environment was deployed and configured.
