...
sidebar_position: 6
description: "Configure syslog and SNMP forwarding from network devices to the syslog Linux server"
category: "Runbook"
scope: "Configure syslog and SNMP forwarding from network devices to the NDM Linux se..."
purpose: "Configure syslog and SNMP forwarding from network devices to the NDM Linux server"
...
:::info Syslog Server Can Live Anywhere
...
| Inbound UDP 514 | Syslog receive from network devices |
| Inbound UDP 161 | SNMP polling |
| Inbound UDP 162 | SNMP trap receive |
| Outbound to Azure Monitor | Required for AMA forwarding |
...
- Syslog Linux server deployed and accessible (see [Server Requirements](#syslog-server-requirements) above; `compute.vms.management.syslog.syslog_ip`)
...
| Previous | Up |
|----------|----|
| [← Task 06: Deploy OMIMSWAC Monitoring](./task-05-deploy-omimswac-monitoring.mdx) | [Phase 02: Monitoring & Observability](./index.mdx) |
...
|----------|-------------|---------|
| Syslog Server | `operational.monitoring.syslog_server` | `10.0.0.20` |
| Syslog Port | `operational.monitoring.syslog_port` | `514` |
| Log Level | `operational.monitoring.network_log_level` | `Informational` |
