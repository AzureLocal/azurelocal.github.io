...
category: "Runbook"
scope: "Configure alert rules and action groups for Azure Local monitoring and notifi..."
purpose: "Configure alert rules and action groups for Azure Local monitoring and notifications"
