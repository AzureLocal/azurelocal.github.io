...
category: "Runbook"
scope: "Configure Azure Backup for Azure Local VM protection"
purpose: "Configure Azure Backup for Azure Local VM protection"
...
| Previous | Up | Next |
|----------|-----|------|
| --- | [Phase 03: Backup & DR](./index.mdx) | [Task 02: Configure Site Recovery ->](./task-02-configure-site-recovery.mdx) |
