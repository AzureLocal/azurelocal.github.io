...
sidebar_position: 1
description: "SDN prerequisites validation and Day 2 NSG management for Azure Local — deployment and initial NSG creation are covered in Post-Deployment"
---
...
:::tip SDN Deployment
The actual SDN enablement procedure is in [Post-Deployment: Deploy SDN](../../04-cluster-deployment/phase-06-post-deployment/task-01-deploy-sdn.mdx). Initial NSG creation and logical network association are in [Post-Deployment: Configure NSGs](../../04-cluster-deployment/phase-06-post-deployment/task-07-configure-nsgs.mdx). This section covers **prerequisites** and **Day 2 NSG management** (adding/removing rules, troubleshooting).
:::
...
| 2 | [Manage Network Security Groups](task-02-configure-network-security-groups.mdx) | Day 2 NSG management — add/remove rules, associate NICs, troubleshoot |
...
- [ ] NSGs created during [Post-Deployment Task 07](../../04-cluster-deployment/phase-06-post-deployment/task-07-configure-nsgs.mdx) (for Day 2 operations)
