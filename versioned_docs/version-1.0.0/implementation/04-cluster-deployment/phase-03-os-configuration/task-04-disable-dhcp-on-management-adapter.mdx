...
keywords:
  ...
  - NDIS
  - network adapter
  - Invoke-DisableDHCP-Orchestrated
  - Disable-DHCPOnAllAdapters
status: "Active"
---
...
|----------|-------------|---------|
| Management Adapter Name | `cluster.network.management.adapter_name` | `Management` |
| Static IP Address | `cluster.network.management.ip_address` | `10.0.0.10` |
| Subnet Mask | `cluster.network.management.subnet_mask` | `255.255.255.0` |
...
| 2.0 | 2026-03-05 | Azure Local Cloud | Full rewrite to standards — complete frontmatter, 2-tab structure (Direct + Orchestrated), Standalone tab removed, full embedded scripts, NDIS defensive pattern, variables.yml integration in orchestrated script |
