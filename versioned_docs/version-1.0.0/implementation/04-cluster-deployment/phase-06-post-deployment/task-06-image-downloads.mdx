...
category: "Runbook"
scope: "Download Azure Marketplace VM images to the Azure Local cluster for Arc VM de..."
purpose: "Download Azure Marketplace VM images to the Azure Local cluster for Arc VM deployment"
...
> **MASTER REFERENCE**: [Azure Local VM Images](https://learn.microsoft.com/en-us/azure/azure-local/manage/virtual-machine-image-azure-marketplace)
...
| → Next | [Task 07 — Configure NSGs](./task-07-configure-nsgs.mdx) |
