...
category: "Runbook"
scope: "Deploy VMFleet for comprehensive storage performance testing and baseline doc..."
purpose: "Deploy VMFleet for comprehensive storage performance testing and baseline documentation"
...
> **MASTER REFERENCE**: [VMFleet Storage Testing Framework](https://github.com/microsoft/diskspd/tree/master/Frameworks/VMFleet)
> **MASTER REFERENCES**:
...
| Previous | Up | Next |
|----------|-----|------|
| [← Task 1: Infrastructure Health Validation](task-01-infrastructure-health-validation.mdx) | [Testing & Validation](index.mdx) | [Task 3: Network & RDMA Validation →](task-03-network-rdma-validation.mdx) |
