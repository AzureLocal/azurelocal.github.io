...
| 1.1 | 2026-03-04 | Azure Local Cloud | Add Optional badge, Azure badge, full frontmatter, fix tab labels and script paths, remove duplicate sections, standards alignment |
| 1.2 | 2026-03-04 | Azure Local Cloud | Reorder: promoted to Task 01 (BOSS config before ISO mount) |