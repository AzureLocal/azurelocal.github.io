...
sidebar_position: 7
description: "Choose the appropriate Azure Landing Zone deployment model for your deployment requirements"
---
...
- **Enterprise environments** with strict governance and compliance requirements
...
The Simplified deployment provides a streamlined structure for smaller deployments, POCs, or cost-conscious scenarios while still maintaining organizational best practices.

#### When to Use

- **Proof of Concept (POC)** deployments
- **Azure Local Cloud labs and demos**
- **Smaller organizations** with limited Azure footprint
...
|-------------|:------------:|:---------:|
| Enterprise environment with existing Azure governance | ✅ | ❌ |
...
During discovery workshops, ask these questions to determine the appropriate model:

### Governance and Compliance

1. Are there existing Azure governance policies?
2. Are there regulatory compliance requirements (SOX, HIPAA, FedRAMP)?
3. Are audit trails required at the subscription level?
...
7. Is separation of duties required?
...
13. Is there an Enterprise Agreement or MCA?
...
- Discovery Sessions - Requirements Workshops
