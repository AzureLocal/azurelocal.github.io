...
sidebar_position: 2
description: "Pre-deployment planning procedures"
---
...
> **SCOPE**: Pre-discovery alignment and preparation 
> **PURPOSE**: Prepare deployment teams for discovery sessions 
...
| **Network Component** | **Standard Allocation** | **Site Specific** | **Notes** |
| ------------------------ | ----------------------- | --------------------- | -------------------- |
| **Management VLAN** | 100-199 range | TBD | Site preference |
