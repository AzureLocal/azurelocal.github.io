...
> **PURPOSE**: Assess existing workloads for Azure Local 
...
Workload discovery and assessment is a critical phase where deployment teams evaluate existing applications and services to determine:
