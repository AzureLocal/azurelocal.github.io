...
| Path | Purpose |
|------|---------|
| `repo-management/README.md` | Entry point for the folder and local repo-management conventions |
| `repo-management/plans/` | Implementation plans, design notes, scoped initiatives |
| `repo-management/checklists/` | Audit checklists, migration lists, operational gates |
| `repo-management/roadmaps/` | Milestones, phased plans, and release horizons |
| `repo-management/reports/` | Discovery outputs, coverage reports, validation summaries |
| `repo-management/scripts/` | Helper scripts used for repo-management or governance tasks |
| `repo-management/working/` | Drafts, temporary notes, and working material not yet promoted |

### Allowed Content

The `repo-management/` folder may contain:

- repo-specific project management notes
- migration plans
- governance helper scripts
- repo audits and reports
- roadmap and planning documents
- working drafts for repo operations
